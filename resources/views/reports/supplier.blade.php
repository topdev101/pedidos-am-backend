...
<body>
    ...
    @php
        ...
        $total_amount = $supplier->purchases()->sum('total_cost');
                        ...
                        <tbody>
                            ...
                            @if ($supplier->country)
                                <tr>
                                    ...
                                    <td class="value">{{$supplier->country->name}}</td>
                                </tr>
                            @endif
                            <tr>
                                <td>{{__('page.city')}} : </td>
        ...
        <tbody>
            ...
            @foreach ($data as $item)
                @php
                    ...
                    $footer_grand_total += $item->total_cost;
                    $footer_paid += $paid;
                @endphp
                <tr>
                    <td class="timestamp">{{date('d/m/Y', strtotime($item->purchased_at))}}</td>
                    <td class="reference_no">{{$item->reference_no}}</td>
                    <td class="grand_total"> {{number_format($item->total_cost)}} </td>
                    <td class="payment">
                        @php
                    ...
                    <td class="balance"> {{number_format($item->total_cost - $paid)}} </td>
                </tr>
            @endforeach
        </tbody>
        <tfoot>
